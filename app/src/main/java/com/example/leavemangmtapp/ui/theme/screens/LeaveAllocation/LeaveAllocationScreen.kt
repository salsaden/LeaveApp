        ...
        bottomBar = {
            BottomAppBar(
                ...
                IconButton(onClick = { navController.navigate(ROUTE_LEAVEAALOCATION) })  {
                    Icon(imageVector = Icons.Filled.AddToPhotos, contentDescription = "AssignLeaves", tint = Color.Blue, modifier = Modifier.padding(bottom = 20.dp))
                    Text(text = "ASSIGN LEAVE", color = Color.Blue,fontWeight = FontWeight.Black,fontSize = 10.sp, textAlign = TextAlign.Justify,modifier = Modifier.padding(top = 25.dp))
                }
